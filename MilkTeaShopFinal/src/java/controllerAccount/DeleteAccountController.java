...
public class DeleteAccountController extends HttpServlet {
    ...
    private static final String ERROR = "AccountManagementController";
    private static final String SUCCESS = "AccountManagementController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (loginUser.getId() .equals(id)) {
                ...
                boolean checkDelete = dao.deleteAccount(id);
                if (checkDelete) {
                    url = SUCCESS;
                }
            }
