...
public class AddProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String imagePath = request.getParameter("txt_imagePath");
            String search = request.getParameter("txt_search");
            
            
            
            
            boolean ok = DAOProduct.ToolProduct.addProduct(new Product("", pname, price, imagePath, ""));
            
            if(ok){
                request.setAttribute("status", "ADD PRODUCT SUCCESSFULLY! ");
                
               
            } else{
                request.setAttribute("status", "ADD PRODUCT ERROR");}
